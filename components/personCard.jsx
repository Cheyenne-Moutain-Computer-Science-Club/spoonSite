export default function PersonCard({ obj, place }) {
	const name = obj.name.replace("-Student", "");
	const image = obj.image;
	const score = obj.score;

	return (
		<div className="m-4 rounded-lg border border-gray-700 bg-gray-800 shadow-md">
			<div className="flex flex-col items-center pb-10 pt-3">
				...
				<span className="text-md text-gray-400">{score}</span>
			</div>
		</div>
	);
}
