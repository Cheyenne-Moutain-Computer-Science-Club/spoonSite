				...
				<div className="mt-5 flex flex-col justify-center">
					...
					{user ? (
						...
						<div className="flex flex-col items-center justify-center">
							...
							<button
								className="w-50 mt-5 rounded-md border-2 border-indigo-600 bg-indigo-600 py-2 px-8 text-xl font-medium text-white duration-150 hover:bg-transparent hover:text-gray-900 dark:hover:text-white"
								onClick={() => signIn()}
							>
								Sign in
							</button>
